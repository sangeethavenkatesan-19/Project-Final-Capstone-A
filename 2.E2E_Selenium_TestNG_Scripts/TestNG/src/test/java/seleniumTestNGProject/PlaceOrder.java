...
public class PlaceOrder {
	...
	@Test(description = "View cart and Place Orders")
	public void placeOrder() throws InterruptedException {
		...
		//going back to home page
		WebElement home1 = driver.findElement(By.xpath("//*[@id=\"mynavbar\"]/ul/li[1]/a"));
		home1.click();
		//add to cart completed
		
		//navigation bar
		WebElement button1 = driver.findElement(By.xpath("//*[@id=\"mynavbar\"]/ul/li[1]/a"));
		button1.click();
